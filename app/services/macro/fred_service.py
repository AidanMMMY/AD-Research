...
_GLOBAL_SERIES: list[FredSeriesMeta] = [
    # ── US Index (FRED publishes daily closes with a slight delay; yfinance
    #    is the primary real-time source for these same codes in the
    #    global-indices pipeline, so these act as a fallback). ──

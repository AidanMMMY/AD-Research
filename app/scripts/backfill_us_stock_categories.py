...
Usage:
    docker exec etf-backend python3 app/scripts/backfill_us_stock_categories.py
    docker exec etf-backend python3 app/scripts/backfill_us_stock_categories.py --batch-size 500
"""

...
const entries: TermEntry[] = [
  ...
  // ===== 标的池 =====
  {
    key: 'snapshot',
    title: '快照记录',
    shortDesc: '保存关注池/研究篮子在某一时刻的成员配置，便于回溯对比。',
    fullDesc: '快照记录把关注池/研究篮子当前的成员和配置信息保存为一个历史版本。你可以在后续随时查看之前的快照，对比关注池结构的变化，或在需要时恢复到某个历史状态。',
    interpretation: '建议在成员变更前后创建快照，形成可追溯的投研日志。',
  ...
  },
  {
    ...
    title: '池整体表现',
    shortDesc: '关注池/研究篮子按等权近似计算的收益、夏普、回撤等综合表现（供快速参考）。',
    fullDesc: '池整体表现把池内各只 ETF 的收益结合起来，计算近似的 1 月/3 月收益、夏普比率和最大回撤，反映整个关注池/研究篮子的历史表现。其中“最大回撤”是各成员历史最大回撤的近似，不是按组合净值路径计算的真实组合最大回撤；夏普、收益等指标也是近似值，供快速参考。',
    interpretation: '关注池/研究篮子的整体表现不仅取决于单只 ETF，还取决于成员结构和相关性。若需精确评估，应使用组合净值回测。',
    relatedPageType: 'pool_detail',
  },
  {
    key: 'strategy_type',

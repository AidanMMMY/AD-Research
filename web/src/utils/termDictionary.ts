...
const entries: TermEntry[] = [
  ...
  // ===== 全球市场速览（Dashboard 市场脉搏 / Global Markets） =====
  {
    key: 'global_sp500',
    title: '标普 500',
    shortDesc: '美国 500 家大型上市公司组成的股票指数，被广泛视为美股整体表现的代表。',
    fullDesc: '标准普尔 500 指数（S&P 500）由标准普尔公司编制，涵盖美国市值最大的 500 家上市公司，按市值加权。它覆盖了约 80% 的美国股票总市值，被广泛用作美股大盘的基准。',
    interpretation: '上涨通常反映美国经济和企业盈利预期向好，下跌则反映风险厌恶或衰退担忧。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_nasdaq', 'global_dow', 'vix'],
  },
  {
    key: 'global_nasdaq',
    title: '纳斯达克',
    shortDesc: '以科技股为主的美股指数，反映美国科技和成长型公司的表现。',
    fullDesc: '纳斯达克综合指数（Nasdaq Composite）包含在纳斯达克交易所上市的数千家公司，其中以科技、互联网、生物技术等成长型公司为主。由于科技股权重高，其对利率变化和成长风格切换敏感。',
    interpretation: '上涨反映风险偏好提升和科技股景气；下跌可能反映利率上行或成长风格估值收缩。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_sp500', 'global_dow'],
  },
  {
    key: 'global_dow',
    title: '道琼斯',
    shortDesc: '由 30 家美国大型蓝筹股组成的价格加权指数，历史悠久。',
    fullDesc: '道琼斯工业平均指数（Dow Jones Industrial Average）由 30 家具有代表性的美国大型企业组成，采用价格加权计算。成分股多为传统行业蓝筹，历史上常被视为美国经济晴雨表。',
    interpretation: '波动通常小于纳斯达克，对工业、金融、消费等传统经济景气度敏感。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_sp500', 'global_nasdaq'],
  },
  {
    key: 'SPY.US',
    title: 'SPY',
    shortDesc: '追踪标普 500 指数的 ETF，是全球交易量最大的 ETF 之一。',
    fullDesc: 'SPDR S&P 500 ETF Trust（SPY）是追踪标普 500 指数的 ETF，交易代码 SPY。它流动性极高，常被视为标普 500 现货走势和美股情绪的实时参考。',
    interpretation: '价格走势与标普 500 高度一致，日内波动反映实时资金流向。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_sp500'],
  },
  {
    key: 'us_dgs10',
    title: 'US 10Y',
    shortDesc: '美国 10 年期国债收益率，被视为全球无风险利率基准和资产定价之锚。',
    fullDesc: '美国 10 年期国债收益率反映市场对美国经济、通胀和货币政策的长期预期。它被称为“全球资产定价之锚”，对股票估值、汇率、房贷利率等有广泛影响。',
    interpretation: '收益率上升通常压制成长股估值，利好美元；下降则反映避险需求或降息预期。',
    relatedPageType: 'global_markets',
    relatedTerms: ['us_t10y3m', 'treasury_yield'],
  },
  {
    key: 'usd_cny',
    title: 'USD/CNY',
    shortDesc: '美元兑人民币汇率，反映人民币相对美元的强弱。',
    fullDesc: 'USD/CNY 表示 1 美元可兑换多少人民币。数值上升意味着人民币贬值、美元升值；数值下降意味着人民币升值。该汇率受中美利差、贸易差额、央行政策等因素影响。',
    interpretation: '人民币贬值通常利好出口型企业，但可能加剧资本外流压力；升值则有利于进口和外债负担。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_dxy', 'usd_eur'],
  },
  {
    key: 'usd_eur',
    title: 'USD/EUR',
    shortDesc: '美元兑欧元汇率，反映美元与欧元的相对强弱。',
    fullDesc: 'USD/EUR 表示 1 美元可兑换多少欧元。数值上升意味着美元走强、欧元走弱；数值下降意味着美元走弱、欧元走强。该汇率受欧美利差、经济增长差异和避险情绪影响。',
    interpretation: '美元走强通常反映全球避险需求或美联储加息预期；欧元走强则反映欧洲经济相对改善。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_dxy', 'usd_cny'],
  },
  {
    key: 'us_t10y3m',
    title: 'T10Y3M',
    shortDesc: '美国 10 年期与 3 个月期国债收益率之差，是常用的衰退预警指标。',
    fullDesc: '10 年期与 3 个月期美国国债收益率利差，又称期限利差。当短端收益率高于长端（倒挂）时，通常预示未来 12-18 个月经济衰退风险上升。',
    formula: 'T10Y3M = 10 年期美债收益率 - 3 个月期美债收益率',
    interpretation: '正值为正常状态；负值（倒挂）常被视为衰退信号，但并非每次倒挂都会立刻衰退。',
    relatedPageType: 'global_markets',
    relatedTerms: ['us_dgs10', 'treasury_yield'],
  },
  {
    key: 'global_shcomp',
    title: '上证',
    shortDesc: '上海证券交易所综合指数，反映 A 股主板整体表现。',
    fullDesc: '上证综指（上证指数）由上海证券交易所全部上市股票加权计算，是观察 A 股主板市场整体表现的重要指标。金融、能源、工业等传统行业权重较高。',
    interpretation: '上涨反映 A 股整体情绪向好，下跌则反映市场整体承压。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_szse', 'global_csi300'],
  },
  {
    key: 'global_hsi',
    title: '恒生',
    shortDesc: '香港恒生指数，反映港股市场主要大型公司表现。',
    fullDesc: '恒生指数由香港恒生银行编制，涵盖香港市场市值最大、流动性最好的 50 多家公司，包括大量金融、科技、地产和中资企业。受内地经济、外资流向和地缘政治影响较大。',
    interpretation: '上涨通常反映外资回流港股或中概股情绪改善；下跌则反映外资流出或地缘政治担忧。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_n225', 'global_shcomp'],
  },
  {
    key: 'global_n225',
    title: '日经',
    shortDesc: '日本日经 225 指数，反映东京证券交易所主要大型公司表现。',
    fullDesc: '日经 225 指数由日本经济新闻社编制，选取东京证券交易所 225 家代表性公司。日本出口型企业和科技股占比较高，对日元汇率、全球经济周期和央行政策敏感。',
    interpretation: '上涨反映日本经济和出口预期改善，日元走弱通常利好出口企业。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_hsi', 'global_sp500'],
  },
  {
    key: 'global_szse',
    title: '深证',
    shortDesc: '深圳证券交易所综合指数，反映深圳市场整体表现。',
    fullDesc: '深证成指涵盖深圳证券交易所代表性上市公司，其中中小企业、科技、制造和成长股占比较高。相比上证综指，更偏向成长风格。',
    interpretation: '上涨反映成长股和中小盘情绪活跃；下跌则反映风险偏好下降。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_shcomp', 'global_csi300'],
  },
  {
    key: 'global_kospi',
    title: 'KOSPI',
    shortDesc: '韩国综合股价指数，反映韩国股市整体表现。',
    fullDesc: 'KOSPI 是韩国交易所主要股票市场指数，涵盖韩国大型上市公司，以科技、制造、汽车、金融企业为主。受全球半导体周期、韩元汇率和地缘政治影响较大。',
    interpretation: '上涨通常反映韩国经济和全球科技周期向好；下跌则反映外部需求放缓。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_n225', 'global_hsi'],
  },
  {
    key: '510300.SH',
    title: '沪深300ETF',
    shortDesc: '追踪沪深 300 指数的 A 股 ETF，反映沪深两市大市值蓝筹表现。',
    fullDesc: '华泰柏瑞沪深 300 ETF（510300.SH）跟踪沪深 300 指数，覆盖 A 股市值最大、流动性最好的 300 只股票，是 A 股核心资产配置工具之一。',
    interpretation: '价格走势与 A 股大盘蓝筹高度相关，常被用作 A 股大盘的 proxy。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_csi300', 'global_shcomp'],
  },
  {
    key: '159915.SZ',
    title: '创业板ETF',
    shortDesc: '追踪创业板指数的 A 股 ETF，反映 A 股成长型和创新型企业表现。',
    fullDesc: '易方达创业板 ETF（159915.SZ）跟踪创业板指数，成分股以成长型科技、医药、新能源企业为主。波动性通常高于沪深 300。',
    interpretation: '上涨反映 A 股风险偏好和成长风格占优；下跌则反映市场避险情绪升温。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_szse', 'global_shcomp'],
  },
  {
    key: 'global_ftse',
    title: 'FTSE 100',
    shortDesc: '英国富时 100 指数，反映伦敦证券交易所市值最大的 100 家公司。',
    fullDesc: '富时 100 指数（FTSE 100）由英国富时集团编制，包含在伦敦证券交易所上市的 100 家市值最大公司。由于成分股多为跨国企业，指数受英镑汇率和全球经济影响较大。',
    interpretation: '上涨反映英国及欧洲经济信心改善；英镑走弱通常利好跨国企业盈利。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_dax', 'global_cac'],
  },
  {
    key: 'global_dax',
    title: 'DAX',
    shortDesc: '德国 DAX 指数，反映法兰克福证券交易所主要大型企业表现。',
    fullDesc: 'DAX 指数由德国证券交易所编制，包含 40 家德国最大上市公司（2021 年从 30 只扩至 40 只），以汽车、化工、工业、金融为主。德国是欧洲最大经济体，DAX 被视为欧洲经济风向标。',
    interpretation: '上涨反映德国和欧洲经济景气改善；下跌则反映欧洲制造业和出口承压。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_ftse', 'global_cac'],
  },
  {
    key: 'global_cac',
    title: 'CAC 40',
    shortDesc: '法国 CAC 40 指数，反映巴黎证券交易所 40 家大型企业表现。',
    fullDesc: 'CAC 40 指数由法国巴黎证券交易所编制，包含 40 家法国大型上市公司，以奢侈品、能源、金融、工业为主。是观察法国和欧洲市场的重要指标。',
    interpretation: '上涨反映法国及欧洲消费、工业景气改善；下跌则反映欧洲经济或政治不确定性。',
    relatedPageType: 'global_markets',
    relatedTerms: ['global_dax', 'global_ftse'],
  },
  {
    key: 'BTC.US',
    title: 'BTC',
    shortDesc: '比特币，全球最大的加密货币，常被视为风险资产和数字货币风向标。',
    fullDesc: '比特币（Bitcoin）是去中心化数字货币，由区块链技术支撑。价格波动大，受全球流动性、监管政策、机构 adoption 和宏观风险情绪影响。',
    interpretation: '大幅上涨通常反映风险偏好和流动性宽松；剧烈下跌常与监管收紧或去杠杆有关。',
    relatedPageType: 'global_markets',
    relatedTerms: ['vix'],
  },

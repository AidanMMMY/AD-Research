      ...
      <Alert
        ...
        description={
          <span style={{ fontSize: 12, color: 'var(--text-tertiary)' }}>
            在 <code style={{ background: 'var(--bg-input)', padding: '1px 6px', borderRadius: 4 }}>.env</code> 中设置 <code style={{ background: 'var(--bg-input)', padding: '1px 6px', borderRadius: 4 }}>DEEPSEEK_API_KEY=sk-...</code> 后重启服务即可激活。
          </span>
        }
      />
    );

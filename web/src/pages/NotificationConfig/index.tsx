  ...
  const handleCreate = async (values: any) => {
    try {
      ...
      if (values.channel_type === 'webhook') {
        ...
        config_json.subject_prefix = values.subject_prefix || 'AlloyResearch';
        ...
        >
          ...
          {channelType === 'email' && (
            <>
              ...
              <Form.Item name="subject_prefix" label="邮件主题前缀" initialValue="AlloyResearch">
                <Input placeholder="AlloyResearch" />
              </Form.Item>

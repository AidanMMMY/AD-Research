...
| 5 | FMP | K 线（美股 / 基本面） | US | HTTP | FMP_API_KEY | 250/day | 每日 |
| 6 | yfinance | K 线（兜底） | Global | pip 免费 | 无 | 频繁易限流 | 兜底 |
| 7 | Binance Public | 加密货币 K 线 | Crypto | HTTP 公开 | 无 | 1200/min | 每日 |
| 8 | FRED | 美国宏观 | US | HTTP | FRED_API_KEY | 120/min | 每日 |
| 9 | BEA | 美国宏观 | US | HTTP | BEA_API_KEY | 100/min | 每周 |
| 10 | BLS | 美国劳工统计 | US | HTTP | BLS_API_KEY (可选) | 25/day（无 key）/ 500/day | 每周 |
| 11 | 东方财富研报 | 券商研报 | A 股 | akshare 库 | 无 | 视源 | 每日 |
| 12 | 巨潮 cninfo | 上市公司公告 / 定期报告 | A 股 | HTTP 公开 | 无 | 600/hour | 每日 |
| 13 | SEC EDGAR | 美股 10-K/10-Q | US | HTTP | 无（UA 必填） | 10/sec | 每周 |
| 14 | 百度指数 / Google Trends | 情绪代理 | CN/US | pytrends + akshare | 无 | 60s/req | 每日 |
| 15 | 中金所/3 交易所 | 商品期货 | CN | akshare 库 | 无 | 视源 | 每日 |
| 16 | 雪球 | 散户讨论 / 社交 | A 股 | HTTP + Cookie | XUEQIU_COOKIE | 视 Cookie | 5 min |
| 17 | 新浪财经 / 新华财经 / Yahoo / CNBC / Reddit | 财经新闻 | Global | RSS | 无 | 公开 | 5 min |
| 18 | CoinDesk / Cointelegraph | 加密货币新闻 | Crypto | RSS | 无 | 公开 | 5 min |
| 19 | 巨潮公告 | 公告流 | A 股 | HTTP 公开 | 无 | 公开 | 10 min |
...
| DEEPSEEK_API_KEY | https://platform.deepseek.com | 注册即有 | ✅ 已配置 |
